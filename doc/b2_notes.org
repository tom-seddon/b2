...
#+begin_src markdown
  ,* The GUI Font Size setting has been renamed to GUI Font Scale, now a scale value rather than a pixel size. If you previously changed this setting, that change will be lost, and you'll need to set it up again in the Options dialog. Apologies
  ...
  ,* Windows: improve support for high-DPI displays
#+end_src
