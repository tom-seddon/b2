...
|  Size | What        | Notes                                      |
|-------+-------------+--------------------------------------------|
| 12288 | private RAM | ANDY - but doesn't this overlap with 0463? |

*** Master

| Size | What        | Notes                                             |
|------+-------------+---------------------------------------------------|
| 4096 | private RAM | ANDY - but doesn't this overlap with 0463? |
...
| Size | What   | Notes                                        |
|------+--------+----------------------------------------------|
| 8192 | FS RAM | HAZEL -  but doesn't this overlap with 0463? |
