...
#+begin_src c++
  ...
  struct NewKeymap {
      ...
      map<string,NewKeymapKey> keys;
  };

  union NewKeymapKey {
      string;//name
      int;//number;
      vector<NewKeymapKeySym>;//sym;
  };
  ...
  struct Windows {
      ...
      bool screenshot_filtery
      bool screenshot_correct_aspect_ratioy
      bool screenshot_last_vsyncy
      bool full_screeny
      bool prefer_shortcutsy
      bool auto_scaley
