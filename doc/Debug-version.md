...
- `o` - OS ROM ($c000...$ffff)
- `i` - standard I/O area ($fc00...$feff) - FRED/JIM via 1 MHz bus
  connector, SHEILA
- `j` - I/O area ($fc00...$fdff) - FRED/JIM via cartridge port (Master
  only)
- `x` - I/O area ($fee0...$feff) - Tube access via external connector
- `y` - I/O area ($fee0...$feff) - Tube access via internal connector
  (Master only)
