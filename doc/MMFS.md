...
- **Memory-mapped I/O** - Registers at `0xFE1C` for read/write operations
...
BBCMicroState creates MMFS instance
    ↓
BBCMicro registers MMIO handlers at 0xFE1C
    ↓
MMFS ROM communicates with emulated card
```

The emulation is ROM-agnostic and works with both MMFS v1 and v2 ROMs by providing block-level access to the image file.
