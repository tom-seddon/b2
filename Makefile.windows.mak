...
github_ci_windows:
	$(PYTHON3) "./bin/b2build.py" --verbose release-binary-windows "$(shell $(PYTHON3) "./bin/b2build.py" print-build-suffix)" --timestamp "$(shell $(PYTHON3) "./bin/b2build.py" print-build-timestamp)" $(if $(UPLOAD),--gh-release,)
