...
bool CanHaveSCSI(BBCMicroTypeID type_id) {
    return Has1MHzBus(type_id) || IsElectron(type_id);
}
...
bool IsInternalParasite(BBCMicroTypeID type_id, BBCMicroParasiteType parasite_type) {
    return parasite_type == BBCMicroParasiteType_MasterTurbo && type_id == BBCMicroTypeID_Master;
}
...
bool IsExternalParasite(BBCMicroTypeID type_id, BBCMicroParasiteType parasite_type) {
    if (!IsInternalParasite(type_id, parasite_type)) {
