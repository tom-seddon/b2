...
std::string AppHandler::GetDisplayedRecentPath(const std::string &path, const RecentPaths &paths) const {
    (void)paths;
...
bool OrdinaryAppHandler::GetFixedDisplaySize(ImVec2 *display_size) const {
    (void)display_size;
...
uint32_t OrdinaryAppHandler::GetUIFlags() const {
    return 0;
}
...
bool OrdinaryAppHandler::IsFlashingCursorAlwaysVisible() const {
    return false;
}
