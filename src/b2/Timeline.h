...
public:
    ...
    void AddEvent(BeebEvent &&event);

    void SetEnd2MHzCycles(uint64_t end_2MHz_cycles);
protected:
private:
    std::unique_ptr<BeebLoadedConfig> m_initial_config;
    ...
    void Init2MHzCycles(uint64_t num_2MHz_cycles);
};
