...
#define SHIFT(K) ((uint32_t)(K) | PCKeyModifier_Shift)
...
static const BeebKeymap::Mapping g_keysym_common[] = {
    ...
    {SDLK_LCTRL, BeebKeySym_Ctrl},
    {SDLK_RCTRL, BeebKeySym_Ctrl},
    {SDLK_a, BeebKeySym_A},
    {SDLK_s, BeebKeySym_S},
    {SDLK_d, BeebKeySym_D},
    {SDLK_f, BeebKeySym_F},
    ...
    {SDLK_LSHIFT, BeebKeySym_Shift},
    {SDLK_RSHIFT, BeebKeySym_Shift},
    {SDLK_z, BeebKeySym_Z},
    {SDLK_x, BeebKeySym_X},
    {SDLK_c, BeebKeySym_C},
    {SDLK_v, BeebKeySym_V},
