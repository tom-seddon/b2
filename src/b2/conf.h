...
// Centralize a few slightly arbitrary key choices...

#define AT_SCANCODE (SDL_SCANCODE_HOME)
#define BREAK_SCANCODE (SDL_SCANCODE_F11)
#define SHIFT_LOCK_SCANCODE (SDL_SCANCODE_SCROLLLOCK)
