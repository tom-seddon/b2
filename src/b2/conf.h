...
#if SYSTEM_OSX
// Mostly covered by the inbuilt macOS functionality, which the SDL stuff
// doesn't quite interoperate with.
#define ENABLE_SDL_FULL_SCREEN 0
#else
#define ENABLE_SDL_FULL_SCREEN 1
#endif

//////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////

// Got some way into this, then got distracted. I'll finish it one day!
//
// This define deliberately strips out the bare minimum.
#define BBCMICRO_ENABLE_MASTER_COMPACT 1
