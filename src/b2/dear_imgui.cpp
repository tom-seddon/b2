...
ImGuiIDPusher::ImGuiIDPusher(const std::string &str) {
...
ImGuiDisabledPusher::ImGuiDisabledPusher(bool disabled) {
    this->BeginDisabled(disabled);
}

//////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////

ImGuiDisabledPusher::~ImGuiDisabledPusher() {
    while (m_num_begins > 0) {
        this->EndDisabled();
    }
}
...
void ImGuiDisabledPusher::BeginDisabled(bool disabled) {
...
void ImGuiDisabledPusher::EndDisabled() {
    ASSERT(m_num_begins > 0);
    ImGui::EndDisabled();
    --m_num_begins;
}
