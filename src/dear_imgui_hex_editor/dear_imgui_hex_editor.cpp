...
void HexEditor::DoImGui() {
    ...
    int num_visible_rows;
    {
        ...
        m_last_frame_scroll_y = ImGui::GetScrollY();
...
float HexEditor::GetLastFrameScrollY() const {
    return m_last_frame_scroll_y;
}

//////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////

void HexEditor::SetNextFrameScrollY(float scroll_y) {
    m_next_frame_scroll_y = scroll_y;
}
